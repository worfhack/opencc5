...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////// TABLEAU LISTING DANS LA BACKOFFICE
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /*
    $fields
    $module = false
    $params = null
    $sortable = false //Tableau dragable
    $selectable = false => Ajoute des case à cocher un première colonne.
    $tablesorter = true => Tableau triable. Ajouter addPager() avant Liste
    //*/
...
//Récupère les language disponible. Par défaut enregistre donc les valeurs pour toute les langues existante. (Evite de devoir checker lors des updates)
                ...
                foreach ($languages as $lang) {
                    ...
                    foreach ($this->fields_lang  as $pl)
                    {
                        ...
                        if (is_array($this->$pl)) {
                            $params_lang_s[$pl] = $this->$pl[$lang['id_language']];
                        }else
                        {
                            $params_lang_s[$pl] = $this->$pl;
                        }
                    }
                    $params_lang_s['id_lang'] = $lang['id_language'];
